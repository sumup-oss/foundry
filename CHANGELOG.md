...
- [#1206](https://github.com/sumup-oss/foundry/pull/1206) [`7ee1259`](https://github.com/sumup-oss/foundry/commit/7ee1259610c87ae0c2d7af9a7d4d54625febccfa) Thanks [@connor-baer](https://github.com/connor-baer)! - Upgraded to Stylelint 17. There should be no breaking changes. Refer to the [migration guide](https://stylelint.io/migration-guide/to-17) in case you run into issues.
