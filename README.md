...
Foundry adds the following scripts to your `package.json`:
...
All config files that are generated by Foundry follow a similar format. They import a configuration function, optionally call it with overrides, and export the result, like so:
